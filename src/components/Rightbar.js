    ...
    <Box flex={2} p={2} sx={{display:{xs:"none", sm:"block"}}}>
      <Box position="fixed" width={300}>
        ...
        <ImageList cols={3} rowHeight={100} gap={5}>
          <ImageListItem>
            <img src="https://material-ui.com/static/images/image-list/breakfast.jpg" alt='break'/>
          </ImageListItem>
          <ImageListItem>
            <img src="https://material-ui.com/static/images/image-list/burgers.jpg" alt='break'/>
          </ImageListItem>
          <ImageListItem>
            <img src="https://material-ui.com/static/images/image-list/breakfast.jpg" alt='break'/>
          </ImageListItem>
